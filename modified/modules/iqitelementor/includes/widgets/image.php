...
class Widget_Image extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        $image_html .= sprintf( '<img src="%s" alt="%s"%s />', \IqitElementorWpHelper::esc_attr( $instance['image']['url'] ), \IqitElementorWpHelper::esc_attr( $instance['caption'] ) , $image_class_html );
