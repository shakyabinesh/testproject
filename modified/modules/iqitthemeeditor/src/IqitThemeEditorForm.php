        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Background width'),
                        'name' => 'hm_width',
                        'condition' => array(
                            'h_layout' => '<=1,2,3'
                        ),
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Infinity scroll'),
                        'desc' => $this->module->l('Instead of default pagination, next pages will be added to content on scroll'),
                        'name' => 'pl_infinity',
                        'options' => array(
                            'query' => array(
                                array(
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Product brand'),
                        'name' => 'pl_grid_brand',
                        'options' => array(
                            'query' => array(
                                array(
                    ...
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Discount value'),
                        'desc' => $this->module->l('Show discount value on reduced price label'),
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'color2',
                        'label' => $this->module->l('Browser bar address/header background color'),
                        'name' => 'rm_address_bg',
                        'desc' => $this->module->l('You can set mobile browser header/address bar color. It works with Mobile Chrome, Firefox and Opera browsers. '),
                        'size' => 30,
                    ),
                    array(
                        'type' => 'title_separator',
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'text',
                        'label' => $this->module->l('Linkedin url'),
                        'name' => 'sm_linkedin',
                        'size' => 30,
                    ),
                ),
