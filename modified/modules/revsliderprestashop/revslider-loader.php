...
class RevLoader{
    ...
    public static $admin_scripts = array(),$front_scripts= array(),$front_styles= array(),$admin_styles= array(),$registered_script,$registered_style;
   public $headers, $body;
        ...
        public static function load_admin_styles(){
          ...
          //  var_dump(self::$admin_styles);die();
            foreach(self::$admin_styles as $style){
              //  $document->addStyleSheet($style['src']); 
                Context::getcontext()->controller->addCSS($style['src']);
            }
