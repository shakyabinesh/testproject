					...
					if($source_type == 'youtube' || $source_type == 'vimeo' || 
						...
						if(empty($urlThumb)){	//try to get resized thumb
							...
							$urlThumb = rev_aq_resize($url_img_link, $th_width, $th_height, true, true, true);
                                                       ...
                                                       $urlThumbOld = $urlThumb;
                                                       $dirThumOld = RevSliderFunctionsWP::getImageDirFromUrl($urlThumb);
						...
						if(empty($urlThumb)){
                                                      //  var_dump($dirThumOld);die();
                                                            if($urlThumbOld == false || $urlThumbOld == null || is_dir($dirThumOld)){
                                                                $urlThumb = $slide->getImageUrl();
                                                            }else{
                                                               $urlThumb = $urlThumbOld;
                                                            } 
                                                   // $urlThumb = $slide->getImageUrl();
...
<?php } ?>
			...
			$use_scrolleffect = $this->slider->getParam('fade_scrolleffect','off') !== 'off' || $this->slider->getParam('scale_scrolleffect','off') !== 'off' || $this->slider->getParam('blur_scrolleffect','off') !== 'off' || $this->slider->getParam('grayscale_scrolleffect','off') !== 'off' ? 'on' : 'off';
	...
	public function putSliderBase($sliderID, $gal_ids = array(), $markup_export = false, $settings = array(), $order = array(),$lang='all'){
		...
		try{
			...
			if($this->slider->getParam("js_to_body","false") == "true"){
				...
				$htmlBeforeSlider .= '<script type="text/javascript" src="'.RS_PLUGIN_URL.'public/assets/js/extensions/revolution.extension.actions.min.js"></script>';
                                $htmlBeforeSlider .= '<script type="text/javascript" src="'.RS_PLUGIN_URL.'public/assets/js/extensions/revolution.extension.carousel.min.js"></script>';
                                $htmlBeforeSlider .= '<script type="text/javascript" src="'.RS_PLUGIN_URL.'public/assets/js/extensions/revolution.extension.kenburn.min.js"></script>';
                                $htmlBeforeSlider .= '<script type="text/javascript" src="'.RS_PLUGIN_URL.'public/assets/js/extensions/revolution.extension.layeranimation.min.js"></script>';
                                $htmlBeforeSlider .= '<script type="text/javascript" src="'.RS_PLUGIN_URL.'public/assets/js/extensions/revolution.extension.migration.min.js"></script>';
                                $htmlBeforeSlider .= '<script type="text/javascript" src="'.RS_PLUGIN_URL.'public/assets/js/extensions/revolution.extension.navigation.min.js"></script>';
                                $htmlBeforeSlider .= '<script type="text/javascript" src="'.RS_PLUGIN_URL.'public/assets/js/extensions/revolution.extension.parallax.min.js"></script>';
                                $htmlBeforeSlider .= '<script type="text/javascript" src="'.RS_PLUGIN_URL.'public/assets/js/extensions/revolution.extension.video.min.js"></script>';
