var rs_install_slider = {},
    ...
    RevSliderAdmin = new function() {
        function k() {
            var a = jQuery("#spinner_color").val(),
                b = jQuery("#use_spinner");
            0 != b.val() && 5 != b.val() || (a = "#ffffff");
            var c = jQuery("#spinner_preview .tp-loader.tp-demo");
            c.hasClass("spinner0") || c.hasClass("spinner1") || c.hasClass("spinner2") ? c.css({
                backgroundColor: a
            }) : c.find("div").css({
                backgroundColor: a
            })
        ...
        function l(a, b) {
            ...
            a.find(".tp-loader").remove(), a.append('<div class="tp-loader tp-demo"><div class="dot1"></div><div class="dot2"></div><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>'), a.find(".tp-demo").addClass("spinner" + c.val()), "-1" == c.val() || 0 == c.val() || 5 == c.val() ? jQuery("#spinner_color_row").css({
                display: "none"
            }) : jQuery("#spinner_color_row").css({
                display: "block"
            }), k()
        }
        var a = this,
        ...
        var d = function() {
                var a = jQuery("#alias").val(),
                    b = '[rev_slider alias="' + a + '"]';
        ...
        var g = function(a, b, c, d) {
            ...
            j = function() {
                m(), h(), b = jQuery.parseJSON(g_jsonTaxWithCats), i("post_types", "post_category"), i("product_types", "product_category"), jQuery("#fetch_type").change(function() {
                    ...
                    if ("photosets" == jQuery("select[name=flickr-type]").val())
        ...
        this.initSpinnerAdmin = function() {
            ...
            var a = jQuery("#spinner_preview"),
                b = jQuery("#use_spinner"),
                c = jQuery("#spinner_color"),
                d = c.val();
            ...
            j(), c("update_slider"), jQuery("#button_delete_slider, #button_delete_slider_t").click(function() {
                ...
                var a = jQuery("#sliderid").val(),
                    b = jQuery('input[name="export_dummy_images"]').is(":checked"),
                    c = ajaxurl + UniteAdminRev.return_ajaxurl_param() + "action=" + g_uniteDirPlugin + "_ajax_action&client_action=export_slider&dummy=" + b + "&nonce=" + g_revNonce;
                ...
                jQuery('input[name="reset-slide_transition"]').is(":checked") && (a.slide_transition = jQuery('select[name="def-slide_transition"] option:selected').val()), jQuery('input[name="reset-transition_duration"]').is(":checked") && (a.transition_duration = jQuery('input[name="def-transition_duration"]').val()), jQuery('input[name="reset-image_source_type"]').is(":checked") && (a.image_source_type = jQuery('select[name="def-image_source_type"] option:selected').val()), jQuery('input[name="reset-background_fit"]').is(":checked") && (a.bg_fit = jQuery("#def-background_fit option:selected").val(), "percentage" == a.bg_fit && (a.bg_fit_x = jQuery('input[name="def-bg_fit_x"]').val(), a.bg_fit_y = jQuery('input[name="def-bg_fit_y"]').val())), jQuery('input[name="reset-bg_position"]').is(":checked") && (a.bg_position = jQuery('select[name="def-bg_position"] option:selected').val(), "percentage" == a.bg_position && (a.bg_position_x = jQuery('input[name="def-bg_position_x"]').val(), a.bg_position_y = jQuery('input[name="def-bg_position_y"]').val())), jQuery('input[name="reset-bg_repeat"]').is(":checked") && (a.bg_repeat = jQuery('select[name="def-bg_repeat"] option:selected').val()), jQuery('input[name="reset-kenburn_effect"]').is(":checked") && (a.kenburn_effect = jQuery('input[name="def-kenburn_effect"]').is(":checked") ? "on" : "off"), jQuery('input[name="reset-kb_start_fit"]').is(":checked") && (a.kb_start_fit = jQuery('input[name="def-kb_start_fit"]').val()), jQuery('input[name="reset-kb_easing"]').is(":checked") && (a.kb_easing = jQuery('select[name="def-kb_easing"] option:selected').val()), jQuery('input[name="reset-kb_end_fit"]').is(":checked") && (a.kb_end_fit = jQuery('input[name="def-kb_end_fit"]').val()), jQuery('input[name="reset-kb_duration"]').is(":checked") && (a.kb_duration = jQuery('input[name="def-kb_duration"]').val()), jQuery('input[name="reset-kb_start_offset_x"]').is(":checked") && (a.kb_start_offset_x = jQuery('input[name="def-kb_start_offset_x"]').val()), jQuery('input[name="reset-kb_start_offset_y"]').is(":checked") && (a.kb_start_offset_y = jQuery('input[name="def-kb_start_offset_y"]').val()), jQuery('input[name="reset-kb_blur_start"]').is(":checked") && (a.kb_blur_start = jQuery('input[name="def-kb_blur_start"]').val()), jQuery('input[name="reset-kb_blur_end"]').is(":checked") && (a.kb_blur_end = jQuery('input[name="def-kb_blur_end"]').val()), jQuery('input[name="reset-kb_end_offset_x"]').is(":checked") && (a.kb_end_offset_x = jQuery('input[name="def-kb_end_offset_x"]').val()), jQuery('input[name="reset-kb_end_offset_y"]').is(":checked") && (a.kb_end_offset_y = jQuery('input[name="def-kb_end_offset_y"]').val()), jQuery('input[name="reset-kb_start_rotate"]').is(":checked") && (a.kb_start_rotate = jQuery('input[name="def-kb_start_rotate"]').val()), jQuery('input[name="reset-kb_end_rotate"]').is(":checked") && (a.kb_end_rotate = jQuery('input[name="def-kb_end_rotate"]').val()), UniteAdminRev.ajaxRequest("reset_slide_settings", a)
                ...
                jQuery("#reset_slide_button").css("opacity", "0.5"), jQuery(".rs-reset-slide-setting").each(function() {
                    if (jQuery(this).is(":checked")) return jQuery("#reset_slide_button").css("opacity", "1"), !0
                })
        ...
        var m = function() {
            ...
            n = function(a) {
                var b = jQuery("#list_slides").sortable("toArray"),
                    c = [],
                    d = 0;
        ...
        this.initNewsletterRoutine = function() {
            ...
            var b, c = function(a, c) {
                if (jQuery("#import_dialog_box").html(""), jQuery("#dialog_import_template_slider_info").dialog({
                        ...
                        minHeight: 350,
                        open: function(a, c) {
                            var d = jQuery(a.target).parent(),
                                e = d.find(".ui-dialog-titlebar");
                    ...
                    for (var d in slider_package_uids[a.uid])
                        for (var e in slider_package_uids[a.uid][d]) rs_install_slider[d] = {
                    ...
                    var f = 0,
                        ...
                        i = setInterval(function() {
                            ...
                            if (e <= Object.keys(rs_install_slider).length ? jQuery("#install-slider-counter").css({
                                    width: e / Object.keys(rs_install_slider).length * 100 + "%"
                                }) : jQuery("#install-slider-counter").width("100%"), 0 === d) {
                                f = 0;
                                for (var k in rs_install_slider)
                                    if (0 === rs_install_slider[k].status) {
                                        a.uid = rs_install_slider[k].uid, jQuery("#import_dialog_box_action").html(slider_package_names[rs_install_slider[k].uid].name), rs_install_slider[k].status = 1, UniteAdminRev.ajaxRequest("import_slider_online_template_slidersview_new", a, function(a) {
                                            if (rs_install_slider[k].status = 2, void 0 !== a.slider_id && a.slider_id > 0 && rs_install_ids.push(a.slider_id), a.view !== !1 && (rs_install_url = a.view), a.error.length > 0)
                                                for (var b in a.error) jQuery("#import_dialog_box").append("<div>" + a.error[b] + "</div>");
                                            else
                                                for (var b in a.success);
                                        }, !0);
                                        break
                                    }
                            }
                            j && (clearInterval(i), "true" === c ? (jQuery("#import_dialog_box").append("<div>" + rev_lang.create_draft + "</div>"), UniteAdminRev.ajaxRequest("create_draft_page", {
                                slider_ids: rs_install_ids
                            }, function(a) {
                    ...
                    jQuery("#import_dialog_box").append("<div>" + j + "</div>"), UniteAdminRev.ajaxRequest("import_slider_online_template_slidersview_new", a, function(a) {
                        if (jQuery("#import_dialog_box_action").html(""), a.error.length > 0)
                            for (var b in a.error) jQuery("#import_dialog_box").append("<div>" + a.error[b] + "</div>");
                        else {
                            for (var b in a.success) jQuery("#install-slider-counter").css({
                                width: "100%"
                            });
            ...
            a.get_title_by_uid = function(a) {
                ...
                void 0 !== jQuery("#dialog_import_slider").dialog() && jQuery("#dialog_import_slider").dialog("close"), void 0 !== jQuery("#dialog_import_template_slider").dialog() && jQuery("#dialog_import_template_slider").dialog("close"), jQuery("#dialog_import_template_slider_info").dialog({
                    modal: !0,
                    resizable: !1,
                    width: 450,
                    minHeight: 350,
                ...
                var a = this.id.replace("button_delete_", ""),
                    b = jQuery("#slider_title_" + a).text();
                return 0 != confirm(rev_lang.really_want_to_delete + " '" + b + "' ?") && void UniteAdminRev.ajaxRequest("delete_slider_stay", {
                    sliderid: a
                }, function() {
                ...
                UniteAdminRev.ajaxRequest("toggle_favorite", {
                    id: a
                }, function() {
                ...
                var a = this.id.replace("export_slider_", ""),
                    b = !1,
                    c = ajaxurl + UniteAdminRev.return_ajaxurl_param() + "action=" + g_uniteDirPlugin + "_ajax_action&client_action=export_slider&dummy=" + b + "&nonce=" + g_revNonce;
                c += "&sliderid=" + a, location.href = c
            }), jQuery("body").on("click", ".rs-embed-slider", function() {
                var a = jQuery(this).closest("li.tls-slide").find(".tls-alias").text();
                jQuery(".rs-dialog-embed-slider").find(".rs-example-alias").text(a), jQuery(".rs-dialog-embed-slider").find(".rs-example-alias-1").text('[rev_slider alias="' + a + '"]'), jQuery(".rs-dialog-embed-slider").dialog({
                    modal: !0,
                    resizable: !1,
                    minWidth: 850,
                    minHeight: 300,
                ...
                var a = this.id.replace("export_slider_standalone_", ""),
                    b = !1,
                    c = ajaxurl + UniteAdminRev.return_ajaxurl_param() + "action=" + g_uniteDirPlugin + "_ajax_action&client_action=preview_slider&only_markup=true&dummy=" + b + "&nonce=" + g_revNonce;
                c += "&sliderid=" + a, location.href = c
            })
        };
        var o = function(a) {
        ...
        a.initSlidesListViewPosts = function(a) {
            r(a), jQuery("#select_sortby").change(function() {
                ...
                var b = jQuery(this).data("slideid"),
                    c = {
                        slideID: b,
                        sliderID: a
                    };
        ...
        a.initSlidesListView = function(a) {
            r(a), jQuery("#button_new_slide, #button_new_slide_top").click(function() {
                ...
                var b = this.id.replace("button_duplicate_slide_", ""),
                    c = {
                        slideID: b,
                        sliderID: a
                    };
                ...
                var b = jQuery("#dialog_copy_move"),
                    d = (b.data("textclose"), b.data("textupdate")),
                    e = jQuery(this),
                    f = {};
                f[d] = function() {
                    var b = e.attr("id").replace("button_copy_slide_", ""),
                        c = jQuery("#selectSliders").val(),
                        d = "copy";
            ...
            var c = UniteLayersRev.getLayers(),
                d = {};
            ...
            jQuery(".tp-accordion").click(function() {
                ...
                UniteAdminRev.openAddImageDialog(rev_lang.select_slide_img, function(a, b) {
                    void 0 == b && (b = ""), jQuery("#divbgholder").css("background-image", "url(" + a + ")"), jQuery("#slide_selector .list_slide_links li.selected .slide-media-container ").css("background-image", "url(" + a + ")"), jQuery("#image_url").val(a), jQuery("#image_id").val(b), UniteLayersRev.changeSlotBGs(), jQuery(".bgsrcchanger:checked").click(), jQuery('input[name="kenburn_effect"]').is(":checked") && jQuery('input[name="kb_start_fit"]').change()
                })
                ...
                "external" == a && (jQuery("#slide_bg_external").removeClass("disabled").prop("disabled", ""), jQuery("#button_change_image").removeClass("button-disabled"), t(a), jQuery('input[name="kenburn_effect"]').is(":checked") && jQuery('input[name="kb_start_fit"]').change(), UniteLayersRev.changeSlotBGs())
            }), UniteAdminRev.setColorPickerCallback(function() {
                var a = jQuery("#background_type").val();
                if ("solid" == a) {
                    var b = jQuery("#slide_bg_color").val();
                    jQuery("#divbgholder").css("background-color", b), jQuery("#slide_selector .list_slide_links li.selected .slide-media-container ").css({
                        backgroundColor: b
                    })
                }
            ...
            var f = function(a) {
                var b = jQuery(".list_slide_links").sortable("toArray"),
                    c = [];
                jQuery(b).each(function(a, b) {
            ...
            jQuery(".inputDatePicker").datepicker({
                ...
                var a = jQuery(this).closest("li").attr("id").replace("slidelist_item_", ""),
                    b = {
                        slideID: a,
                        sliderID: c
                    };
                ...
                var d = jQuery(this),
                    e = d.siblings(".loader_delete");
                d.hide(), e.show();
                var f = jQuery(this).closest("li"),
                    g = curSlideID == a ? "delete_slide" : "delete_slide_stay";
                ...
                var a = jQuery(this).closest("li"),
                    b = a.attr("id").replace("slidelist_item_", ""),
                    d = {
                        slider_id: c,
                        slide_id: b
                    };
                ...
                var a = jQuery(this).closest("li"),
                    b = jQuery(this).closest("ul"),
                    d = a.attr("id").replace("slidelist_item_", ""),
                    e = {
                        slider_id: c,
                        slide_id: d
                    };
                ...
                var a = jQuery(this).closest("li"),
                    e = jQuery(this),
                    f = jQuery("#dialog_copy_move"),
                    h = (f.data("textclose"), f.data("textupdate")),
                    e = jQuery(this),
                    i = {};
                i[h] = function() {
                    var b = a.attr("id").replace("slidelist_item_", ""),
                        d = jQuery("#selectSliders").val(),
                        f = "copy";
                ...
                if (confirm(rev_lang.unsaved_changes_will_not_be_added)) {
                    var a = jQuery(this).closest("li"),
                        b = prompt(rev_lang.please_enter_a_slide_title, a.find(".slidetitleinput").val()),
                        c = jQuery('input[name="rs-grid-width"]').val(),
                        d = jQuery('input[name="rs-grid-height"]').val(),
                        e = a.attr("id").replace("slidelist_item_", ""),
                        f = {
                            width: c,
                            height: d
                        };
                ...
                a.stopPropagation();
                var b = UniteAdminRev.getAbsolutePos(this),
                    c = b[0] - 135,
                    d = b[1] - 60,
                    e = jQuery(this),
                    f = e.data("operation"),
                ...
                var a = jQuery(this),
                    b = a.data("lang"),
                    d = jQuery("#langs_float_wrapper").data("iconid");
                if (!d) return !0;
                var e = jQuery("#" + d),
                    f = e.parents(".list_slide_icons"),
                    g = a.data("operation");
            ...
            t = function(a) {
                switch (a) {
                    case "image":
                        ...
                        jQuery("#divbgholder").css("background-image", "url('" + b + "')"), jQuery("#divbgholder").css("background-color", "transparent"), jQuery("#divbgholder").removeClass("trans_bg"), jQuery('input[name="kenburn_effect"]').is(":checked") && jQuery('input[name="kb_start_fit"]').change();
                        break;
                    case "trans":
                    ...
                    case "solid":
                        ...
                        jQuery("#divbgholder").css("background-color", c), jQuery("#slide_selector .list_slide_links li.selected .slide-media-container ").css({
                            backgroundColor: c
                        });
                        break;
                    case "external":
        ...
        a.setStaticCssCaptionsUrl = function(a) {
            ...
            w = CodeMirror.fromTextArea(document.getElementById("textarea_edit_static"), {
                lineNumbers: !0
            })
        }, a.setCodeMirrorSliderEditor = function() {
            x = CodeMirror.fromTextArea(document.getElementById("textarea_show_slider_styles"), {
                lineNumbers: !0
            })
        }, a.setCodeMirrorSliderEditorJS = function() {
            y = CodeMirror.fromTextArea(document.getElementById("textarea_show_slider_javascript"), {
                lineNumbers: !0
            })
        ...
        var B = function() {
            ...
            C = function() {
                jQuery("#button_edit_css_global").click(function() {
                    jQuery("#css-static-accordion").accordion({
                        active: 1
                    }), UniteAdminRev.ajaxRequest("get_slider_custom_css_js", {
                        slider_id: curSliderID
                    }, function(a) {
                        var b = a.css,
                            c = a.js;
                        ...
                        buttons: {
                            Save: function() {
                                var a = {};
                                null != x ? a.css = x.getValue() : a.css = jQuery("#textarea_show_slider_styles").val(), null != y ? a.js = y.getValue() : a.js = jQuery("#textarea_show_slider_javascript").val(), a.slider_id = curSliderID, UniteAdminRev.ajaxRequest("update_slider_custom_css_js", a, function(a) {}), jQuery(this).dialog("close")
                            }
                        }
                    })
