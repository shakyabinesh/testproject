...
var UniteAdminRev = new function() {
    ...
    e.showInfo = function(e) {
        ...
        var o = /<\/?([a-z][a-z0-9]*)\b[^>]*>/gi,
            t = /<!--[\s\S]*?-->|<\?(?:php)?[\s\S]*?\?>/gi;
        return e.replace(t, "").replace(o, function(e, o) {
        ...
        if (e.indexOf("-moz") > -1) {
            var o = e.split(" ");
            delete o[0], e = jQuery.trim(o.join(" "))
        }
        if (e.split(")").length > 2) {
            for (var t = "", r = e.split(")"), u = 0; u < r.length - 1; u++) {
                r[u] += ")";
                var o = r[u].split(",");
                4 == o.length ? (e = o[0] + "," + o[1] + "," + o[2], e += ")") : e = r[u], e = jQuery.trim(e), e = e.match(/^rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*(\d+))?\)$/), t += "#" + i(e[1]) + i(e[2]) + i(e[3]) + " "
            }
            return t
        }
        var o = e.split(",");
        return 4 == o.length && (e = o[0] + "," + o[1] + "," + o[2], e += ")"), e = e.match(/^rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*(\d+))?\)$/), "#" + i(e[1]) + i(e[2]) + i(e[3])
    }, e.getTransparencyFromRgba = function(e, i) {
        var o = e.split(",");
        return 4 == o.length && (i = "undefined" == typeof i || i, i ? o[3].replace(/[^\d.]/g, "") : 100 * o[3].replace(/[^\d.]/g, ""))
    }, e.debug = function(e) {
    ...
    this.hideSuccessMessage = function() {
        o ? (jQuery("#" + o).hide(), o = null) : jQuery("#success_message").slideUp("slow").fadeOut("slow"), y()
    ...
    e.ajaxRequest = function(i, o, t, r, u) {
        var d = {
        ...
        s(), c(), p(), void 0 === r && showWaitAMinute({
            fadeIn: 300,
            ...
            data: d,
            success: function(o) {
                if (void 0 !== r || o.is_redirect || showWaitAMinute({
                        fadeOut: 300
                    }), v(), !o) return e.showErrorMessage("Empty ajax response!"), !1;
                if (-1 == o) return e.showErrorMessage("ajax error!!!"), !1;
                if (0 == o) return e.showErrorMessage("ajax error, action: <b>" + i + "</b> not found"), !1;
                if (void 0 == o.success) return e.showErrorMessage("The 'success' param is a must!"), !1;
                if (0 == o.success) {
                    if (void 0 === u) return e.showErrorMessage(o.message), !1;
                    "function" == typeof t && t(o)
                } else "function" == typeof t && t(o), o.message && _(o.message), o.is_redirect && (location.href = o.redirect_url)
            },
            error: function(i, o, t) {
                void 0 === r && showWaitAMinute({
                    fadeOut: 300
                }), v(), "parsererror" == o && e.debug(i.responseText), e.showErrorMessage("Ajax Error!!! " + o)
            }
        })
    };
    var h = function(e, i) {
        var o = "&TB_iframe=true&height=450&width=960",
            t = uploadurl + o;
    ...
    e.openAddImageDialog = function(e, i, o) {
        ...
        e += "?rand=" + o, i && jQuery("#" + i).remove(), jQuery("head").append("<link>");
        var t = jQuery("head").children(":last");
        t.attr({
            rel: "stylesheet",
            type: "text/css",
            href: e
    ...
    var j = function(e) {
            ...
            var i = e.thumb_medium,
                o = "" != jQuery.trim(jQuery("#input_video_preview").val()) ? jQuery("#input_video_preview").val() : i.url,
                t = '<div class="video-thumbnail-all-wrapper">';
            t += '<div class="video-thumbnail-preview-wrapper"><div id="video-thumbnail-preview" style="background-size:cover; background-position:center center; background-image:url(' + o + "); width:" + i.width + "px; height:" + i.height + 'px;display:inline-block;vertical-align:bottom"></div></div>', t += '<div class="video-content-description">', t += '<div class="video-content-title">' + e.title + "</div>", "undefined" != typeof e.desc_small && (t += e.desc_small), t += "</div>", t += "</div>", jQuery("#video_content").html(t)
        },
        Q = function(e) {
        ...
        g = function(e) {
            ...
            return i = jQuery.trim(i)
        };
    e.onYoutubeCallback = function(e) {
        jQuery("#youtube_loader").hide();
        var i = 200,
            o = {};
        o.id = jQuery("#youtube_id").val(), o.id = jQuery.trim(o.id), o.video_type = "youtube", e[0].width <= 170 || e[0].height <= 140 ? o.title = "YouTube: " + rev_lang.maybe_wrong_yt_id : o.title = "YouTube", o.author = "YouTube", o.link = "", o.description = "", o.desc_small = "", o.description.length > i && (o.desc_small = o.description.slice(0, i) + "..."), o.thumb_small = {
            url: e[0].src,
            width: 200,
            height: 150
        }, o.thumb_medium = {
            ...
            width: e[0].width,
            height: e[0].height
        }, o.video_width = e[0].width, o.video_height = e[0].height, j(o);
        var t = jQuery("#input_video_arguments");
        "" == t.val() && t.val(t.data("youtube")), d = o, jQuery("#video_dialog_tabs").removeClass("disabled"), l = !0, jQuery("#button-video-add").show()
        ...
        e = e[0];
        var o = {};
        o.video_type = "vimeo", o.id = e.id, o.id = jQuery.trim(o.id), o.title = e.title, o.link = e.url, o.author = e.user_name, o.description = e.description, o.description.length > i && (o.desc_small = o.description.slice(0, i) + "..."), o.thumb_large = {
            ...
            width: 100,
            height: 75
        }, o.video_with = 640, o.video_height = 360, j(o);
        var t = jQuery("#input_video_arguments");
        "" == t.val() && t.val(t.data("vimeo")), d = o, jQuery("#video_dialog_tabs").removeClass("disabled"), l = !0, jQuery("#button-video-add").show()
    ...
    var m = function() {
        var e = jQuery("#input_video_fullwidth").is(":checked");
        1 == e ? jQuery("#video_full_screen_settings").show() : (jQuery("#input_video_cover").prop("checked", !1), jQuery("#video_full_screen_settings").hide());
        var i = jQuery("#input_video_cover").is(":checked");
        1 == i ? jQuery("#input_video_ratio_lbl, #input_video_ratio, #input_video_dotted_overlay_lbl, #input_video_dotted_overlay").show() : jQuery("#input_video_ratio_lbl, #input_video_ratio, #input_video_dotted_overlay_lbl, #input_video_dotted_overlay").hide(), RevSliderSettings.onoffStatus(jQuery("#input_video_fullwidth")), RevSliderSettings.onoffStatus(jQuery("#input_video_cover"))
    };
    ...
    var b = function(e) {
            ...
            e.show_cover_pause && 1 == e.show_cover_pause ? jQuery("#input_video_show_cover_pause").prop("checked", "checked") : jQuery("#input_video_show_cover_pause").prop("checked", ""), "undefined" != typeof e.large_controls && 0 == e.large_controls ? jQuery("#input_video_large_controls").prop("checked", "") : jQuery("#input_video_large_controls").prop("checked", "checked"), "undefined" != typeof e.leave_on_pause && 0 == e.leave_on_pause ? jQuery("#input_video_leave_fs_on_pause").prop("checked", "") : jQuery("#input_video_leave_fs_on_pause").prop("checked", "checked"), jQuery("#input_video_start_at").val(e.start_at), jQuery("#input_video_end_at").val(e.end_at), jQuery("#input_video_volume").val(e.volume), RevSliderSettings.onoffStatus(jQuery("#input_video_nextslide")), RevSliderSettings.onoffStatus(jQuery("#input_video_force_rewind")), RevSliderSettings.onoffStatus(jQuery("#input_video_fullwidth")), RevSliderSettings.onoffStatus(jQuery("#input_video_control")), RevSliderSettings.onoffStatus(jQuery("#input_video_mute")), RevSliderSettings.onoffStatus(jQuery("#input_disable_on_mobile")), RevSliderSettings.onoffStatus(jQuery("#input_video_cover")), RevSliderSettings.onoffStatus(jQuery("#input_video_stopallvideo")), RevSliderSettings.onoffStatus(jQuery("#input_video_allowfullscreen")), RevSliderSettings.onoffStatus(jQuery("#input_use_poster_on_mobile")), RevSliderSettings.onoffStatus(jQuery("#input_video_show_cover_pause")), RevSliderSettings.onoffStatus(jQuery("#input_video_large_controls")), RevSliderSettings.onoffStatus(jQuery("#input_video_leave_fs_on_pause")), RevSliderSettings.onoffStatus(jQuery("#input_video_show_visibility")), RevSliderSettings.onoffStatus(jQuery("#input_video_play_inline")), "audio" === e.video_type ? (jQuery("#button-video-add").hide(), jQuery("#button-audio-add").show()) : (jQuery("#button-video-add").show(), jQuery("#button-audio-add").hide()), jQuery("#video_dialog_tabs").removeClass("disabled"), jQuery("#reset_video_dialog_tab").click()
        },
        w = function(e) {
        ...
        k = function() {
            jQuery("#video_radio_youtube").prop("checked", !0), jQuery("#video_radio_vimeo").click(function() {
                ...
                jQuery(this).is(":checked") && (jQuery("#input_video_fullwidth").is(":checked") || jQuery("#input_video_fullwidth").prop("checked", !0), RevSliderSettings.onoffStatus(jQuery("#input_video_fullwidth"))), m()
                ...
                j(!1), jQuery("#youtube_loader").show();
                var e = jQuery("#youtube_id").val();
                e = jQuery.trim(e), e = f(e), jQuery("#youtube_id").val(e);
                var i = new Image;
                i.onload = function() {
                    var e = jQuery(this);
                    UniteAdminRev.onYoutubeCallback(e)
                }, i.src = "https://img.youtube.com/vi/" + e + "/sddefault.jpg", jQuery("#video_content").show(), setTimeout("UniteAdminRev.videoDialogOnError()", 2e3)
                ...
                if (jQuery("#video_content").hide(), e) {
                    var u = {};
                    u.video_type = "html5", u.urlPoster = jQuery("#html5_url_poster").val(), u.urlMp4 = jQuery("#html5_url_mp4").val(), u.urlWebm = jQuery("#html5_url_webm").val(), u.urlOgv = jQuery("#html5_url_ogv").val(), u.video_width = 480, u.video_height = 360, u = w(u), "function" == typeof n && n(u), jQuery("#dialog_video").dialog("close")
                } else if (o) {
                    var u = {};
                    u.video_type = "streamyoutube", u.video_width = 480, u.video_height = 360, u = w(u), "function" == typeof n && n(u), jQuery("#dialog_video").dialog("close")
                } else if (t) {
                    var u = {};
                    u.video_type = "streamvimeo", u.video_width = 480, u.video_height = 360, u = w(u), "function" == typeof n && n(u), jQuery("#dialog_video").dialog("close")
                } else if (r) {
                    var u = {};
                    u.video_type = "streaminstagram", u.video_width = 480, u.video_height = 360, u = w(u), "function" == typeof n && n(u), jQuery("#dialog_video").dialog("close")
                } else if (i) {
                    var u = {};
                    u.video_type = "audio", u.urlAudio = jQuery("#html5_url_audio").val(), u.video_width = 200, u.video_height = 34, u = w(u), "function" == typeof n && n(u), jQuery("#dialog_video").dialog("close")
                } else {
                    if (!d) return !1;
                    d = w(d), "function" == typeof n && n(d), jQuery("#dialog_video").dialog("close")
                }
                try {
                ...
                j(!1), jQuery("#vimeo_loader").show(), jQuery("#video_content").show();
                var e = jQuery("#vimeo_id").val();
                e = jQuery.trim(e), e = g(e);
                var i = "//www.vimeo.com/api/v2/video/" + e + ".json?callback=UniteAdminRev.onVimeoCallback";
                jQuery.getScript(i), setTimeout("UniteAdminRev.videoDialogOnError()", 2e3)
            }), jQuery("#input_video_fullwidth").change(m)
        },
        S = function() {
    ...
    e.parseCssMultiAttribute = function(e) {
        ...
        jQuery("#eg-font-setting-change").click(function() {
            ...
            jQuery("#font-dialog-wrap").dialog({
                ...
                buttons: [{
                    ...
                    click: function() {
                        var i = {};
                        return i.handle = e.sanitize_input(jQuery('input[name="eg-font-handle"]').val()), i.url = jQuery('input[name="eg-font-url"]').val(), i.handle.length < 3 || i.url.length < 3 ? (alert(rev_lang.handle_at_least_three_chars), !1) : void UniteAdminRev.ajaxRequest("add_google_fonts", i, function(e) {})
                    }
                }]
            })
		...
		jQuery('body').on('click', '.eg-hook-delete', function(){
			if(confirm('Really delete Hook?')){
                ...
                e.initfontAccordion = function(){
		jQuery(".fontpostbox-arrow").each(function(i) {
