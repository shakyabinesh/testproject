	...
	<div id="basic_objectlibrary_license_block">
		...
		<div class="license_deep_content" id="png_license_content">
			...
			<ul>
				...
				<li><?php echo 'If you need .psd files for objects, you can purchase it freom the original<br>author <a target="_blank" class="rspb_darklink" href="https://creativemarket.com/Qeaql/126175-Scene-creator-Top-view">here</a>'; ?></li>
			</ul>
		</div>
