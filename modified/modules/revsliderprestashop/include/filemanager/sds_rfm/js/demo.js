...
! function(e, a, r) {
    ...
    function n() {
        jQuery("#textfile_create_area").parent().parent().remove(), e.ajax({
            type: "GET",
            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=new_file_form"
        }).done(function(a) {
            bootbox.dialog(a, [{
                ...
                callback: function() {
                    ...
                    if (null !== a) {
                        ...
                        e.ajax({
                            type: "POST",
                            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.fexecute&action=create_file",
                            data: {
                                path: t,
                                name: a,
                                new_content: r
    ...
    function i(a) {
        ...
        e.ajax({
            type: "POST",
            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=get_file&sub_action=edit&preview_mode=text",
            data: {
                path: r
            }
        }).done(function(t) {
            bootbox.dialog(t, [{
                ...
                callback: function() {
                    ...
                    e.ajax({
                        type: "POST",
                        url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.fexecute&action=save_text_file",
                        data: {
                            path: r,
                            new_content: a
                        }
    ...
    function l() {
        e.ajax({
            type: "POST",
            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=get_lang",
            data: {}
        }).done(function(a) {
            bootbox.dialog(a, [{
                label: jQuery("#cancel").val(),
                ...
                callback: function() {
                    ...
                    e.ajax({
                        type: "POST",
                        url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=change_lang",
                        data: {
                            choosen_lang: a
                        }
                    }).done(function(e) {
    ...
    function o(a) {
        ...
        e.ajax({
            type: "POST",
            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=chmod",
            data: {
                path: t,
                permissions: n,
                folder: i
                ...
                callback: function() {
                    ...
                    if ("" != n && "undefined" != typeof n) {
                        ...
                        "" != l && "undefined" != typeof l || (l = "none"), e.ajax({
                            type: "POST",
                            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.fexecute&action=chmod",
                            data: {
                                path: t,
                                new_mode: n,
                                is_recursive: l,
    ...
    function s() {
        bootbox.confirm(jQuery("#lang_clear_clipboard_confirm").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function(a) {
            1 == a && e.ajax({
                type: "POST",
                url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=clear_clipboard",
                data: {}
            }).done(function(e) {
    ...
    function d(a, r) {
        if ("copy" == r || "cut" == r) {
            ...
            t = a.hasClass("directory") ? a.find(".rename-file-paths").attr("data-path") : a.find(".rename-file-paths").attr("data-path"), e.ajax({
                type: "POST",
                url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=copy_cut",
                data: {
                    path: t,
                    sub_action: r
                }
        ...
        bootbox.confirm(jQuery("#lang_paste_confirm").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function(r) {
            if (1 == r) {
                ...
                t = "undefined" != typeof a ? a.find(".rename-folder").attr("data-path") : jQuery("#sub_folder").val() + jQuery("#fldr_value").val(), e.ajax({
                    type: "POST",
                    url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.fexecute&action=paste_clipboard",
                    data: {
                        path: t
                    }
                }).done(function(e) {
    ...
    function g(a, r, t, n, i) {
        null !== t && (t = _(t), e.ajax({
            type: "POST",
            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.fexecute&action=" + a,
            data: {
                path: r,
                name: t.replace("/", "")
            }
        ...
        U = {
            contextActions: {
                ...
                unzip: function(a) {    
                    ...
                    show_animation(), e.ajax({
                        type: "POST",
                        url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=extract",
                        data: {
                            path: r
                        }
                    }).done(function(e) {
                ...
                jQuery("#filter-input").on("keyup", function() {
                    ...
                    jQuery(this).val(r), a && I(function() {
                        jQuery("li", "ul.grid ").each(function() {
                            ...
                            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=filter&type=" + r
                        }).done(function(e) {
                            "" != e && bootbox.alert(e)
                        }), I(function() {
            ...
            uploadURL: function() {
                jQuery("#uploadURL").on("click", function(a) {
                    ...
                    show_animation(), e.ajax({
                        type: "POST",
                        url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.upload",
                        data: {
                            path: t,
                            path_thumb: n,
                            url: r
            ...
            makeSort: function(a) {
                ...
                jQuery(".sorter").on("click", function() {
                    ...
                    r = jQuery("#sort_by").val() !== t.attr("data-sort") || 0 == r, a ? (e.ajax({
                        url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=sort&sort_by=" + t.attr("data-sort") + "&descending=" + (r ? 1 : 0)
        ...
        if (U.makeSort(o), U.makeFilters(o), U.uploadURL(), jQuery("#info").on("click", function() {
                ...
                bootbox.prompt(jQuery("#insert_folder_name").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function(a) {
                    if (null !== a) {
                        ...
                        e.ajax({
                            type: "POST",
                            url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.fexecute&action=create_folder",
                            data: {
                                path: r,
                                name: a
                            }
                ...
                jQuery(".view-controller button").removeClass("btn-inverse"), jQuery(".view-controller i").removeClass("icon-white"), a.addClass("btn-inverse"), a.find("i").addClass("icon-white"), e.ajax({
                    url: "index.php?option=com_revslider&view=sdsfmjson&task=sdsfmjson.ajax_calls&action=view&type=" + a.attr("data-value")
                }).done(function(e) {
                    "" != e && bootbox.alert(e)
