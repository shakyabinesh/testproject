            ...
            <div class="row no-gutters align-items-center row-mobile-buttons">
                ...
                <div class="col col-mobile-btn col-mobile-btn-cart ps-shoppingcart text-center {if isset($iqitTheme.cart_style) && $iqitTheme.cart_style == "floating"}dropdown{else}side-cart{/if}">
                   <div id="mobile-cart-wrapper">
                    <a id="mobile-cart-toogle" class="m-nav-btn" data-toggle="dropdown"><i class="fa fa-shopping-bag mobile-bag-icon" aria-hidden="true"><span id="mobile-cart-products-count" class="cart-products-count cart-products-count-btn">{$cart.products_count}</span></i>
