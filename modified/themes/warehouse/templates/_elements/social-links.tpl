...
<ul class="social-links {if isset($class)}{$class}{/if}">
  {if isset($iqitTheme.sm_facebook) == 1 && $iqitTheme.sm_facebook != ''}<li class="facebook"><a href="{$iqitTheme.sm_facebook}" target="_blank"><i class="fa fa-facebook-official" aria-hidden="true"></i></a></li>{/if}
  ...
  {if isset($iqitTheme.sm_pinterest) == 1 && $iqitTheme.sm_pinterest != ''}<li class="pinterest"><a href="{$iqitTheme.sm_pinterest}" target="_blank"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>{/if}
  ...
  {if isset($iqitTheme.sm_vimeo) == 1 && $iqitTheme.sm_vimeo != ''}<li class="vimeo"><a href="{$iqitTheme.sm_vimeo}" target="_blank"><i class="fa fa-vimeo" aria-hidden="true"></i></a></li>{/if}
  {if isset($iqitTheme.sm_linkedin) == 1 && $iqitTheme.sm_linkedin != ''}<li class="linkedin"><a href="{$iqitTheme.sm_linkedin}" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>{/if}
</ul>
{/block}
